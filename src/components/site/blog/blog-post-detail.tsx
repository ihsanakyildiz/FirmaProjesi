  ...
  return (
    <>
      <section className="relative overflow-hidden border-b border-site-border bg-site-surface py-12 sm:py-14">
        ...
        <div className="relative mx-auto grid max-w-7xl px-4 sm:px-6 lg:grid-cols-[minmax(0,1fr)_18rem] lg:gap-12 lg:px-8">
      ...
      <section className="py-12 sm:py-16">
        <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[minmax(0,1fr)_18rem] lg:gap-12 lg:px-8">
          <article>
            {image ? (
